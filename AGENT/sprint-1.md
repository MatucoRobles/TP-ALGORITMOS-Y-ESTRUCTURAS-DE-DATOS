...
* **1.3.** Elegir y justificar el diseño de las estructuras de datos para usuarios y tweets, asegurando que no se definan límites arbitrarios de capacidad.
...
* **2.3.** Definir y documentar el caso obligatorio 2: Comportamiento de un usuario que no posee tweets.
* **2.4.** Definir y documentar el caso obligatorio 3: Búsqueda de un tweet que no existe en el sistema.
* **2.5.** Definir y documentar el caso obligatorio 4: Eliminación del primer tweet de la lista.
* **2.6.** Definir y documentar el caso obligatorio 5: Eliminación del último tweet de la lista.
* **2.7.** Definir y documentar el caso obligatorio 6: Eliminación de un tweet en posición intermedia.
...
## Paso 3: Desarrollo de la Plataforma Cwitter
* **3.1.** Configurar la estructura de archivos en ANSI C dividida en `main.c`, `include/cwitter.h` y `src/cwitter.c`.
* **3.2.** Implementar la funcionalidad de registro de nuevos usuarios sin límites fijos ni arbitrarios.
* **3.3.** Implementar la funcionalidad de inicio de sesión (login) y cierre de sesión (logout).
* **3.4.** Implementar la funcionalidad de publicación de tweets con un límite estricto de hasta 140 caracteres.
* **3.5.** Implementar la funcionalidad de modificación de tweets publicados por el usuario activo.
* **3.6.** Implementar la funcionalidad de eliminación de tweets publicados por el usuario activo.
* **3.7.** Implementar la funcionalidad de consulta del feed global (visualizar todos los tweets de la plataforma).
* **3.8.** Implementar la funcionalidad de búsqueda de tweets (por término, contenido o autor).
* **3.9.** Implementar la persistencia de datos (carga de usuarios y tweets al iniciar el programa; guardado automático al realizar cambios o cerrar la sesión).
